...
from . import views
from cart.views import add_to_cart, remove_one_item_from_cart, remove_all_item_from_cart
...
urlpatterns = [
    ...
    path('<slug>/remove-all', remove_all_item_from_cart, name="remove-all-item-cart"),
]